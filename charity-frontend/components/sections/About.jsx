...
const defaultData = {
  ...
  description:
     "ঐকতান ফাউন্ডেশন অসচ্ছল ও মেধাবী শিক্ষার্থীদের শিক্ষাজীবনে এগিয়ে যেতে সহায়তা করার একটি সামাজিক উদ্যোগ। বিশেষ করে প্রান্তিক ও সুবিধাবঞ্চিত এলাকার মেধাবী শিক্ষার্থীদের জন্য আমরা আর্থিক সহায়তা, শিক্ষা ও ক্যারিয়ার-সংক্রান্ত তথ্য ও দিকনির্দেশনা প্রদান করি। আমাদের লক্ষ্য—অর্থনৈতিক সীমাবদ্ধতা যেন কোনো শিক্ষার্থীর মেধা, স্বপ্ন ও সম্ভাবনার পথে বাধা হয়ে না দাঁড়ায়। বর্তমান কার্যক্রমের পাশাপাশি ভবিষ্যতে আরও বৃহৎ পরিসরে বিভিন্ন প্রকল্পের মাধ্যমে দেশের আরও বেশি শিক্ষার্থীর পাশে দাঁড়াতে আমরা প্রতিশ্রুতিবদ্ধ। মেধার বিকাশ ও সম্ভাবনার উন্মোচনে—ঐকতান ফাউন্ডেশন, শিক্ষার্থীর স্বপ্নের সহযাত্রী।" ,
  mission:
